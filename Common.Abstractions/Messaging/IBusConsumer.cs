...
public interface IBusConsumer
{
    ...
    /// <summary>
    ///     Consume a message with <see cref="TMessage" /> message type and discovering a message handler that implements
    ///     <see cref="IMessageHandler{TMessage}" /> interface for this type.
    /// </summary>
    /// <typeparam name="TMessage">A type that implements the <see cref="IMessage" />.</typeparam>
    void Consume<TMessage>()
        where TMessage : class, IMessage;
    ...
    /// <summary>
    ///     Consume a message with specific message type with discovering a message handler that implements
    ///     <see cref="IMessageHandler{TMessage}" /> interface for this type.
    /// </summary>
    ...
    /// <summary>
    ///     consume all messages that implements the <see cref="IMessageHandler{TMessage}" /> interface from the assembly of
    ///     the provided type
    /// </summary>
    ...
    /// <summary>
    ///     consume all messages that implements the <see cref="IMessageHandler{TMessage}" /> interface from the assemblies of
    ///     the provided types
    /// </summary>
